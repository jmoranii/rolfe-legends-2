...
gen portrait_wyatt assets/originals/ui/portrait_wyatt.png 1024x1024 wyatt "Square image, 1024x1024.
$STYLE
...
gen portrait_aaron assets/originals/ui/portrait_aaron.png 1024x1024 aaron "Square image, 1024x1024.
$STYLE
...
gen_portrait_liam() {
  local out=assets/originals/ui/portrait_liam.png
...
gen crow assets/originals/enemies/crow.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen gopher assets/originals/enemies/gopher.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen roly_poly assets/originals/enemies/roly_poly.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen mud_blob_m assets/originals/enemies/mud_blob_m.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen mud_blob_s assets/originals/enemies/mud_blob_s.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen mouse_scrappy assets/originals/enemies/mouse_scrappy.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen mouse_zippy assets/originals/enemies/mouse_zippy.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen mouse_pudge assets/originals/enemies/mouse_pudge.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen mouse_whiskers assets/originals/enemies/mouse_whiskers.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen puffball assets/originals/enemies/puffball.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen magpie assets/originals/enemies/magpie.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen barn_spider assets/originals/enemies/barn_spider.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen old_scarecrow assets/originals/enemies/old_scarecrow.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen ornery_ram assets/originals/enemies/ornery_ram.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen scarecrow_post assets/originals/enemies/scarecrow_post.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen rogue_combine assets/originals/enemies/rogue_combine.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen mud_king assets/originals/enemies/mud_king.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen raccoon_bandit assets/originals/enemies/raccoon_bandit.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen waltzing_weasel assets/originals/enemies/waltzing_weasel.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen snapping_turtle assets/originals/enemies/snapping_turtle.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen possum_defender assets/originals/enemies/possum_defender.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen possum_healer assets/originals/enemies/possum_healer.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen thorny_bramble assets/originals/enemies/thorny_bramble.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen porcupine assets/originals/enemies/porcupine.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen fox assets/originals/enemies/fox.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen raccoon_ringleader assets/originals/enemies/raccoon_ringleader.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen raccoon_minion assets/originals/enemies/raccoon_minion.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen raccoon_king assets/originals/enemies/raccoon_king.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen ball_lightning assets/originals/enemies/ball_lightning.png 1024x1024 - "Square image, 1024x1024.
$NSTYLE
...
gen hail_cloud assets/originals/enemies/hail_cloud.png 1024x1024 - "Square image, 1024x1024.
$NSTYLE
...
gen flooding_creek assets/originals/enemies/flooding_creek.png 1024x1024 - "Square image, 1024x1024.
$NSTYLE
...
gen passing_squall assets/originals/enemies/passing_squall.png 1024x1024 - "Square image, 1024x1024.
$NSTYLE
...
gen debris_tangle assets/originals/enemies/debris_tangle.png 1024x1024 - "Square image, 1024x1024.
$NSTYLE
...
gen thunderhead assets/originals/enemies/thunderhead.png 1024x1024 - "Square image, 1024x1024.
$NSTYLE
...
gen ghost_wind assets/originals/enemies/ghost_wind.png 1024x1024 - "Square image, 1024x1024.
$NSTYLE
...
gen wind_funnel assets/originals/enemies/wind_funnel.png 1024x1024 - "Square image, 1024x1024.
$NSTYLE
...
gen dust_devil assets/originals/enemies/dust_devil.png 1024x1024 - "Square image, 1024x1024.
$NSTYLE
...
gen big_twister assets/originals/enemies/big_twister.png 1024x1024 - "Square image, 1024x1024.
$NSTYLE
...
gen big_twister_p2 assets/originals/enemies/big_twister_p2.png 1024x1024 - "Square image, 1024x1024.
$NSTYLE
...
gen thunder assets/originals/enemies/thunder.png 1024x1024 - "Square image, 1024x1024.
$NSTYLE
...
gen lightning assets/originals/enemies/lightning.png 1024x1024 - "Square image, 1024x1024.
$NSTYLE
...
gen battle1 assets/originals/backgrounds/battle1.png 1536x1024 - "Wide landscape image, 3:2 ratio, 1536x1024.
$SCENE
...
gen battle2 assets/originals/backgrounds/battle2.png 1536x1024 - "Wide landscape image, 3:2 ratio, 1536x1024.
$SCENE2
...
gen battle3 assets/originals/backgrounds/battle3.png 1536x1024 - "Wide landscape image, 3:2 ratio, 1536x1024.
$SCENE3
...
gen map1 assets/originals/backgrounds/map1.png 1024x1536 - "Vertical image, 2:3 ratio, 1024x1536.
$SCENE
...
gen map2 assets/originals/backgrounds/map2.png 1024x1536 - "Vertical image, 2:3 ratio, 1024x1536.
$SCENE2
...
gen map3 assets/originals/backgrounds/map3.png 1024x1536 - "Vertical image, 2:3 ratio, 1024x1536.
$SCENE3
...
gen title assets/originals/ui/title.png 1024x1536 - "Vertical image, 2:3 ratio, 1024x1536.
$SCENE
...
gen duck_pond assets/originals/events/duck_pond.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen old_well assets/originals/events/old_well.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen pie_contest assets/originals/events/pie_contest.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen beehive assets/originals/events/beehive.png 1024x1024 - "Square image, 1024x1024.
$CSTYLE
...
gen burn_barrel assets/originals/events/burn_barrel.png 1024x1024 - "Square image, 1024x1024.
$SCENE2
...
# deployed copies are web-weight JPEGs derived from the originals
[ ${#GENERATED[@]} -gt 0 ] && [ "${DRY:-0}" != "1" ] && ./assets/optimize-art.sh >/dev/null && echo "(optimize-art.sh refreshed the deployed JPEGs)"
